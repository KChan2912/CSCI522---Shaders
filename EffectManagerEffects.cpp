...
#	endif
	...
	}
	{
		...
		m_map.add("StdMesh_CelShader_Tech", hEffect);
	}

	{
		...
		pEffect->loadTechnique(
			"StdMesh_Shadowed_VS", "main",
			NULL, NULL, // geometry shader
			"StdMesh_WindowBox_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"StdMesh_WindowBox_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::STD_MESH_PS_IN;
		pEffect->m_effectDrawOrder = EffectDrawOrder::First;

		m_map.add("StdMesh_WindowBox_Tech", hEffect);
	}
	...
	}
	{
		...
		pEffect->loadTechnique(
			"DetailedMesh_Shadowed_VS", "main",
			NULL, NULL, // geometry shader
			"DetailedMesh_CelShaderPass_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriBackCull,
			PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"DetailedMesh_CelShader_Tech");

		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		pEffect->m_effectDrawOrder = EffectDrawOrder::First;
		m_map.add("DetailedMesh_CelShader_Tech", hEffect);
	}

	{
		...
		pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
		m_map.add("DetailedSkin_CelShader_Tech", hEffect);
	...
	{
		Handle hOutlinefx("EFFECT", sizeof(Effect));
		Effect* pOutlinefx = new(hOutlinefx) Effect(*m_pContext, m_arena, hOutlinefx);
		pOutlinefx->loadTechnique(
			"ColoredMinimalMesh_VS", "main",
			NULL, NULL, // geometry shader
			"ColoredMinimalMesh_Outline_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriNoCull,
			PEDepthStencilState_NoZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"sobelTech");
		pOutlinefx->m_psInputFamily = EffectPSInputFamily::REDUCED_MESH_PS_IN;

		m_map.add("sobeloutline.fx", hOutlinefx);
	}

	{
		...
		pOutlinefx->loadTechnique(
			"ColoredMinimalMesh_VS", "main",
			NULL, NULL, // geometry shader
			"ColoredMinimalMesh_CelReColor_PS", "main",
			NULL, NULL, // compute shader
			PERasterizerState_SolidTriNoCull,
			PEDepthStencilState_NoZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
			"celrecolorTech");
		...
		m_map.add("celrecolor.fx", hOutlinefx);
	}
